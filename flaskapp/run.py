...
@app.route('/index')
def index():
    return render_template('index.html', s1_text = displayTweets.get('s1').get('data')[0].get('text'), 
                           s1_name = displayTweets.get('s1').get('includes').get('users')[0].get('name'), 
                           s1_link = displayTweets.get('s1').get('data')[0].get('text'))
